...
TrialSet(:,3) = repmat(10:5:45,1,6);
TrialSet(:,4) = repelem(7:5:32,8);
TrialSet(:,5) = repmat(2,48,1);
TrialSet(:,6) = repmat(1,48,1);
...
ParamSet(n).IdPat           = [1:4]; % 4 patterns, 1:4 on SD card
...
ParamSet(n).TrialPause      =       1;   % Do not change: hardcoded into position function
