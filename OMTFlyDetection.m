...
MaxEyesDist = 95; % max distance between the centroid and the head % 85 for Martha's rig % 110 for Sara's rig
...
figure;
data=vertcat(Track.Bangle);
max(data)
plot(data, 'b');
hold on
data=vertcat(Track.Hangle);
plot(data, 'g');
